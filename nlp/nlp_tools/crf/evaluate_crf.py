...
def main():
    ...
    for dataset in datasets:
        train.append("inputs\\crf_input\\training_input\\" + dataset + ".json")
        test.append("inputs\\crf_input\\testing_input\\" + dataset + ".json")
    ...
    for dataset in datasets:
        train.append("inputs\\crf_input\\training_input_no_secondary\\" + dataset + ".json")
        test.append("inputs\\crf_input\\testing_input_no_secondary\\" + dataset + ".json")
