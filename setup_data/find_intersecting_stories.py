...
def main():
    raw_data_path, visual_narrator_path, gpt_3_5_v0125_path, \
    ...
    intersect_stories = find_intersection(raw_data_stories, visual_narrator_stories, gpt_3_5_v0125_stories,
    ...
    save_results(intersect_stories, duplicates, left_out_raw_data, left_out_visual_narrator, left_out_gpt_3_5_v0125, 
...
def command():
    ...
    try:
        ...
        return args.load_raw_data_path, args.load_visual_narrator_path, args.load_gpt_3_5_v0125_path, args.load_gpt_3_5_v0613_2023_path, \
               args.load_gpt_3_5_v0613_2024_path, args.load_gpt_4_turbo_v0125_path, args.load_gpt_4_v0613_path, args.save_name
...
def find_intersection(raw_data, visual_narrator, gpt_3_5_v0125, gpt_3_5_v0613_2023, gpt_3_5_v0613_2024, gpt_4_turbo_v0125, gpt_4_v0613):
    '''
    ...
    first_intersection = set(raw_data).intersection(set(visual_narrator))
...
def save_results(intersect_stories, duplicates, left_out_raw_data, left_out_visual_narrator, left_out_gpt_3_5_v0125, left_out_gpt_3_5_v0613_2023, 
                 left_out_gpt_3_5_v0613_2024, left_out_gpt_4_turbo_v0125, left_out_gpt_4_v0613, save_name):
    '''
